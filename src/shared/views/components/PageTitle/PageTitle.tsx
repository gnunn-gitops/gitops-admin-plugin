...
import {PageResourceAction} from '../Actions/PageResourceActions';
        ...
        <span className="co-m-pane__heading">
          <h1 className="co-m-pane__name co-resource-item">
            ...
            <span data-test-id="resource-title" className="co-resource-item__resource-name">
              {name ?? obj?.metadata?.name}{' '}{isApplicationRefreshing(obj) ? <Spinner isSVG size='md' /> : <span> </span>}
            </span>
          </h1>
          <div className="co-actions">
            <PageResourceAction obj={obj} actions={actions} />
          </div>
        </span>
      </div>
    </>
