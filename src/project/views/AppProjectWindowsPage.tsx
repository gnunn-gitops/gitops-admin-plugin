...
import { AppProjectKind, SyncWindow } from '@appproject-model';
...
const AppProjectWindowsPage: React.FC<AppProjectWindowsProps> = ({ obj }) => {
...
export default AppProjectWindowsPage;
