...
import { AppProjectKind, Role } from '@appproject-model';

type AppProjectRolesProps = RouteComponentProps<{
    ns: string;
    name: string;
}> & {
    obj?: AppProjectKind;
...
const AppProjectRolesPage: React.FC<AppProjectRolesProps> = ({ obj }) => {
...
export default AppProjectRolesPage;
